...
export BUILD_CPPFLAGS='-I/usr/local/include'
export BUILD_LDFLAGS='-L/usr/local/lib -lintl'
...
#     x86_64-elf-gcc -nostdlib -nostartfiles -shared -x c /dev/null -o $INSTALL_PATH/$TARGET/lib/libc.so
