#! /bin/bash
INSTALL_PATH=/Develop/vendor/toolchain/aarch64-mac-linux-gnu
...
export PATH=/usr/local/opt/make/libexec/gnubin:/usr/local/Cellar/gnu-sed/4.8/bin:/usr/local/Cellar/gnu-sed/4.8/bin:/usr/local/opt/bison/bin:$INSTALL_PATH/bin:$PATH
